...
/**
 * Represents an action to move a tetris piece to the right.
 * 
 * @author Kyle Martens
 * @version 1.0
 */
...
public class RightAction extends AbstractTetrisAction {
    ...
    /**
     * Constructs a new instance of the right action.
     * 
     ...
     * {@inheritDoc}
     * 
     * Moves the current piece to the right on the board.
     */
    @Override
