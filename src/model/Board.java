...
public final class Board extends Observable {
     ...
     * 
     * I added a counter for the number of lines that were removed.
     */
    private void clearLines() {
        //Initialize the remove counter.
        int removeCount = 0;
        for (int i = myBlocks.size() - 1; i >= 0; i--) {
            ...
            if (clear) {
                //Increment the counter when a line is removed.
                removeCount++;
                myBlocks.remove(i);
            }
        }
        setChanged();
        //Notifies the observer of how many lines were removed.
        notifyObservers(removeCount);
    }
